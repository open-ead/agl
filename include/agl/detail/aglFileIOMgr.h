...
public:
    ...
    void save(const sead::XmlDocument& document, const FileIOMgr::DialogArg& dialog_arg, u32 buffer_size);
    void showDialog(sead::hostio::FileInfo* file_info, const sead::SafeString& mode, const sead::SafeString& id1,
                    const sead::SafeString& id2_or_filter, const sead::SafeString& file_name) const;
