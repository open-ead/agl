...
public:
    ExpressionEvaluator();
    ExpressionEvaluator(sead::Heap*, sead::Heap*, sead::AnyDelegate1Const<Clause*> const*);

    void initialize(sead::Heap*, sead::Heap*, sead::AnyDelegate1Const<Clause*> const*);
    u64 findSyntaxLeash(sead::ObjArray<SyntaxLeash>*, Clause const*) const;
